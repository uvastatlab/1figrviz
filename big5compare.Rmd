...
Do approximately 20% of titles account for 80% of use? 

* Each of the Big 5 providers hovers near the 80/20 rule, with about 20% of titles in Springer and Elsevier accounting for 80% of the downloads (all and current year), closer to 25% of titles in Wiley and Taylor & Francis account for 80% of downloads (all and current year), while about 30% of titles from Sage account for the top 80% downloaded articles.
...
The next figure compares the distribution of percent current-year use among journals designated as "high-use" (current year downloads of the journal accounted for the top 80% of use) or not high use. Curves further to the right represent journals with higher rates of current-year use.
...
journal_jr80 %>% filter(big5 == "Yes" & !is.na(jr80_jr5)) %>% 
  ...
  labs(title = "Distribution of Percent Current Year Downloads",
       subtitle = "By Provider and High-Use Designation",
       x = "Percent Current Year Downloads", 
       y = "Proportion of Journals at Each Value",
       fill = "High-Use") 
```

* Among each of the Big 5 providers, the percent of current-year downloads (demarcated by the orange) is notably higher in high-use journals than in journals that did not account for the top 80% of downloads (more of the area under the curves is to the right), suggesting that retaining the high-use journals would preserve much of the current content sought by researchers.

* For both designations -- high-use journals and not high-use journasl -- however, there is a long tail of journals for which most of the use is of newly published material