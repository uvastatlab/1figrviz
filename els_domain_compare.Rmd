...
# boxplot
elsevier_jr80 %>% 
  ggplot(aes(x = domain, y = jr5per, fill = jr80_jr5f)) + 
  geom_boxplot(notch=T) +
  scale_fill_manual(values = c("orange", "blue")) +
  labs(title = "Percent of Current Year Use: Elsevier", 
       subtitle = "By Domain and High-Use Journal Designation",
       x = "Domain", y = "Percent Current Year", fill = "High Use") +
  coord_flip()
```