...
def figure6a_oa_available_articles():
    ...
    for provider_name in big5:
        ...
        oa_2008 = subset_by_provider['2008.2'].tolist()
        oa_by_year.append(oa_2008[0])
        oa_2009 = subset_by_provider['2009.2'].tolist()
        oa_by_year.append(oa_2009[0])
        oa_2010 = subset_by_provider['2010.2'].tolist()
        oa_by_year.append(oa_2010[0])
        oa_2011 = subset_by_provider['2011.2'].tolist()
        oa_by_year.append(oa_2011[0])
        oa_2012 = subset_by_provider['2012.2'].tolist()
        oa_by_year.append(oa_2012[0])
        oa_2013 = subset_by_provider['2013.2'].tolist()
        oa_by_year.append(oa_2013[0])
        oa_2014 = subset_by_provider['2014.2'].tolist()
        oa_by_year.append(oa_2014[0])
        oa_2015 = subset_by_provider['2015.2'].tolist()
        oa_by_year.append(oa_2015[0])
        oa_2016 = subset_by_provider['2016.2'].tolist()
        oa_by_year.append(oa_2016[0])
        oa_2017 = subset_by_provider['2017.2'].tolist()
