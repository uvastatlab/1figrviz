...
The figures above are repeated below but with Elsevier journals disaggregated into the Freedom collection, Subscribed collection, and journals we were not able to match. Note that the disaggregated Elsevier journals no longer sum to 100% as "high use" is calculated within the package, and then the titles are disaggregated into the collections. The three Elsevier bars collectively account for 100% of the titles.
